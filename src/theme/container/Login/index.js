...
import { validateEmail, validatePassword, } from "../../helper/Validation/validate";
...
const Login = () => {
  ...
  const handleSubmit = (e) => {
    ...
    // }
     ...
     else if (cradit.email===user.email && cradit.password===user.password) {
        ...
        <div className="card card-body">
          <div className="wrapper">
            ...
            <p className="small-xl pt-3 text-center">
              <span className="text-muted">Not a member? <Link to="/">Sign up</Link></span>
